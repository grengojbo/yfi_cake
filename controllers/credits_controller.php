...
class CreditsController extends AppController {
	...
	function json_attach($ic_id){
        ...
        //FIXME 9/12/11 This does not seem right ... the update_user_usage part....
        //No, it does actually seems fine...
     ...
     function _returnSearchFilterConditions(){
        ...
        if(array_key_exists('time',$this->params['url'])){
            ...
            if($time_stamp != false){
                ...
                array_push($conditions,array("Credit.created >=" => $date)); //Add This AND filtertjie
            }
        }
