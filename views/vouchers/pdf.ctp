<?php
    ...
    if($format == 'generic'){
        _build_generic($pdf_structure,$language,false);
        return;
    }

    if($format == 'generic_ppv'){
         _build_generic($pdf_structure,$language,true);
        return;
    }
    ...
    function _build_generic($pdf_structure,$lang,$page_per_voucher = false){
